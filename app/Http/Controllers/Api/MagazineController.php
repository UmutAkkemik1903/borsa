...
class MagazineController extends Controller
{
    ...
    {
        $magazineQuery = DB::table('magazine')->where(['deleted_at' => null])->paginate(6, [
    ...
    public function magazineSearch($name)
    {
        if ($name) {
    ...
    {
        DB::table('magazine')->where('id', '=', $id)->update([
