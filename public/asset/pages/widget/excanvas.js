...
(function () {
  ...
  contextPrototype.drawImage = function (image, var_args) {
    ...
    // For Silverlight we don't need to get the size of the img since
    // Silverlight uses the img original dimension if not provided.
    ...
    // If we have a source rect we need to clip the img.
